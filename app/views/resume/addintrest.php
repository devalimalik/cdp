        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row">
              ...
              <p>Add intrests</p>
                ...
                <form action="<?php echo URLROOT; ?>/resumes/addintrest" method="POST" role="form">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 form-group mb-3">
                        <input type="text" value="<?php if(isset($data['name']) && $data['name'] != ''){echo $data['name'];} ?>" name="name" class="form-control" autocomplete="off" id="name" placeholder="Intrest" >
